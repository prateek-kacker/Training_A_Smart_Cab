...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        ## TO DO ##
        ###########
        # Update epsilon using a decay function of your choice=uk.
    ...
    def build_state(self):
        ...
        #else:
         #if waypoint == 'right' and inputs["light"]== 'red' and ( inputs["left"]== 'right' or inputs["left"] == 'left' or inputs["left"]== None):
          #state = (waypoint, inputs["light"],inputs["left"])
         #elif inputs["light"]== 'green'and (waypoint == 'forward' or waypoint == 'right'):
          #state = (waypoint, inputs["light"])
         #elif inputs["light"]== 'green' and waypoint == 'left' and (inputs["oncoming"]=='left' or inputs["oncoming"]==None):
          #Estate = (waypoint, inputs["light"],inputs["oncoming"])
         #else:
          #state = None
    ...
    def choose_action(self, state):
        ...
        if (self.learning == False):
         action = self.env.valid_actions[random.randrange(0,4)]
        else:
         if(random.random()> self.epsilon):
          max_value=max(self.Q[state].values())
          action_list=[]
          for keys in self.Q[state].keys():
           if self.Q[state][keys] == max_value:
            action_list.append(keys)
